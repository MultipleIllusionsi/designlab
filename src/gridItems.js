...
import url8 from './grid_content/8_resultspillow_picture.png?url'
 ...
 */
function item(id, tags, alt, media) {
  return { id, tags, alt, media }
}
...
export const GRID_ITEMS = [
  ...
  item('8', ['graphic', 'interface'], 'Results pillow', { type: 'image', src: url8 }),
